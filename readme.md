...
The data in this repository is the result of exporting corpora from LAnCeLoT. For more information, see `scripts/export/readme.md`.

# Statistics

The corpus contains 863,554 tokens. For more statistics, see `statistics/`. These analyses were generated by `scripts/analyses`
